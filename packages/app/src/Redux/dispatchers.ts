...
export const dispatchUserEdit = (dispatch: React.Dispatch<IAction>, partialUser: Partial<User>) => {
...
export const dispatchUserAccountBalance = (dispatch: React.Dispatch<IAction>, balance: number) => {
	return dispatch({
...
export const dispatchUserAccountBalanceNull = (dispatch: React.Dispatch<IAction>) => {
	return dispatch({ type: ReducerActions.eraseUserAccountBalance });
};

export const dispatchBetsCount = (dispatch: React.Dispatch<IAction>) => {
	return dispatch({ type: ReducerActions.addBet });
};
