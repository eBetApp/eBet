// .env imports
import { REACT_NATIVE_BACK_URL, REACT_NATIVE_S3_URL } from "react-native-dotenv";
...
const putPicture = async (body: FormData, token) => _CRUD.put("user/update-avatar", body, token);
