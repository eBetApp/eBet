...
import { dispatchUserEdit, dispatchUserAccountBalance } from '../Redux/dispatchers';
// Hooks imports
import { useTextInput, useFetch } from '.';
// Utils imports
import { AuthError, classifyAuthError, errorType } from '../Utils/parseApiError';
import { userService, stripeService } from '../Services';
import parseUrl from '../Utils/parseUrl';
import { useInterval } from './useInterval';

/** Invoked on calling fetch() */
export const useEditUserFetch = (state: IState, dispatch: React.Dispatch<IAction>) => {
	// States
	...
	const _preFetchRequest = setError => birthdate !== null && birthdate !== undefined;
...
export const useSetStripeAccountFetch = (state: IState, dispatch: React.Dispatch<IAction>) => {
